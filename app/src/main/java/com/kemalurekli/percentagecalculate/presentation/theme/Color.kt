package com.kemalurekli.percentagecalculate.presentation.theme

import androidx.compose.ui.graphics.Color
val Blue10 = Color(0xFFD0DBE1)
val Blue40 = Color(0xFF2E4A56)
val SelectedYellow = Color(0xFFBE8B2A)
val DarkBlue50 = Color(0xFF12272B)
val DarkBlue90 = Color(0xFF0B171A)
val White10 = Color(0xFFF7F6F6)
